...
urlpatterns = [
    ...
    path("stats/exploit-coverage", VulnerabilityExploitCoverageStatsViewSet.as_view(get_view), name="exploit-coverage"),
    ...
    path(
        "stats/vulnerability-evolution", VulnerabilityEvolutionViewSet.as_view(get_view), name="vulnerability-evolution"
    ),
