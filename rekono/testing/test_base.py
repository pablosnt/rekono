...
class RekonoTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.access_token = content.get('access')
        self.refresh_token = content.get('refresh')
        self.rekono = APIClient(HTTP_AUTHORIZATION=f'Bearer {self.access_token}')   # Configure Rekono API client
