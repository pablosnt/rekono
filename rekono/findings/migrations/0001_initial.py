    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('protocol', models.TextField(choices=[('HTTP', 'Http'), ('SMB', 'Smb')], default='HTTP')),
                ('executions', models.ManyToManyField(related_name='endpoint', to='executions.Execution')),
                ('port', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='endpoint', to='findings.port')),
            ],
            options={
                'abstract': False,
            },
