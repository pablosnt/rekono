...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        CONFIG.load_config_in_frontend(                                         # Load configuration in frontend .env
            FRONTEND_DIR,
            {
                # Defect-Dojo configured
                'VUE_APP_DEFECTDOJO': bool(DEFECT_DOJO.get('URL') and DEFECT_DOJO.get('API_KEY')),
                'VUE_APP_DEFECTDOJO_URL': DEFECT_DOJO['URL'],                   # Defect-Dojo URL to create links
