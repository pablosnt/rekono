...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('findings.models.OSINT', 'Osint'), ('findings.models.Host', 'Host'), ('findings.models.Enumeration', 'Enumeration'), ('findings.models.HttpEndpoint', 'Http Endpoint'), ('findings.models.Technology', 'Technology'), ('findings.models.Vulnerability', 'Vulnerability'), ('findings.models.Exploit', 'Exploit')], max_length=30)),
