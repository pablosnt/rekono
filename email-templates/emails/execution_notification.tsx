...
const tables: {
  ...
  },
  {
    ...
    item: "h",
    columns: [
      { header: "IP", cell: cell("h.ip"), mono: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { header: "Port", cell: cell("p.port"), mono: true },
      { header: "Status", cell: cell("p.status") },
      { header: "Protocol", cell: cell("p.protocol") },
      { header: "Service", cell: cell("p.service") },
    ],
  },
  {
    title: "Paths",
  ...
  },
  {
    ...
    columns: [
      ...
      { header: "Email", cell: cell("c.email") },
      { header: "Username", cell: cell("c.username") },
      { header: "Secret", cell: cell("c.secret"), mono: true },
  ...
  },
  {
    ...
    columns: [
      ...
      { header: "Title", cell: cell("e.title") },
