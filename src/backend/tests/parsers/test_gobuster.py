...
class GobusterTest(ParserTest):
    ...
    cases = [
        ...
        ParserTestCase(
            "dns.txt",
            [
                {"model": OSINT, "data": "chat.example.com", "data_type": OSINTDataType.DOMAIN, "source": "DNS"},
                {"model": OSINT, "data": "10.10.10.10", "data_type": OSINTDataType.IP, "source": "DNS"},
                {"model": OSINT, "data": "10.10.10.11", "data_type": OSINTDataType.IP, "source": "DNS"},
                {"model": OSINT, "data": "echo.example.com", "data_type": OSINTDataType.DOMAIN, "source": "DNS"},
                {"model": OSINT, "data": "10.10.10.10", "data_type": OSINTDataType.IP, "source": "DNS"},
                {"model": OSINT, "data": "10.10.10.11", "data_type": OSINTDataType.IP, "source": "DNS"},
            ],
        ),
