...
class NmapTest(ParserTest, TestCase):
    ...
    cases = [
        ParserTestCase(
            ...
            [
                {"model": Host, "ip": "10.10.10.10", "os": "Linux 3.2 - 4.9", "os_type": HostOS.LINUX},
                {"model": Port, "port": 22, "status": PortStatus.OPEN, "protocol": Protocol.TCP, "service": "ssh"},
                ...
                {"model": Port, "port": 80, "status": PortStatus.OPEN, "protocol": Protocol.TCP, "service": "http"},
                ...
                {"model": Port, "port": 443, "status": PortStatus.OPEN, "protocol": Protocol.TCP, "service": "http"},
                {"model": Technology, "name": "Apache httpd", "version": "2.4.37"},
                {"model": Vulnerability, "name": "CVE-2020-11984", "cve": "CVE-2020-11984"},
                {"model": Vulnerability, "name": "CVE-2021-44790", "cve": "CVE-2021-44790"},
                {"model": Vulnerability, "name": "CVE-2021-39275", "cve": "CVE-2021-39275"},
        ...
        ParserTestCase(
            ...
            [
                ...
                {"model": Port, "port": 21, "status": PortStatus.OPEN, "protocol": Protocol.TCP, "service": "ftp"},
