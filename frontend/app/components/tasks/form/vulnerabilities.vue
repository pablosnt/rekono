<template>
  <div class="space-y-4 mx-auto mt-3">
    <UAlert
      ...
      description="No target port selected. Findings discovered for these vulnerabilities won't be saved to keep the findings chain integrity. Select a target port in the Target section"
      class="mb-4"
    />
    <UFormField
      :required="required"
